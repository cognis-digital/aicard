#!/usr/bin/env sh
# Universal installer for aicard. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/aicard.git"
echo "Installing aicard ..."
