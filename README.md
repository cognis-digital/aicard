...
[![PyPI](https://img.shields.io/pypi/v/cognis-aicard.svg?color=6b46c1)](https://pypi.org/project/cognis-aicard/) [![CI](https://github.com/cognis-digital/aicard/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/aicard/actions) [![License: COCL 1.0](https://img.shields.io/badge/License-COCL%201.0-2b6cb0.svg)](LICENSE) [![Suite](https://img.shields.io/badge/Cognis-Neural%20Suite-6b46c1.svg)](https://github.com/cognis-digital)
...
- [Why aicard?](#why) · [Features](#features) · [Quick start](#quick-start) · [Example](#example) · [How it compares](#how-it-compares) · [Integrations](#integrations) · [Install anywhere](#install-anywhere) · [Related](#related) · [Contributing](#contributing)
